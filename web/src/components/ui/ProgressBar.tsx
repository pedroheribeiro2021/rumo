...
/** Barra de progresso linear — gasto vs. orçamento, proximidade do alvo de preço. */
export function ProgressBar({ value, max = 100, tone = 'brand', height = 8 }: ProgressBarProps) {
